...
<head>
    ...
    <title><?= $pageTitle ?? get_setting('site_name') ?></title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="<?= b_assets('images/favicon.ico') ?>" />

    <!-- Library / Plugin Css Build -->
    <link rel="stylesheet" href="<?= b_assets('css/core/libs.min.css') ?>" />

    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="<?= b_assets('vendor/aos/dist/aos.css') ?>" />

    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="<?= b_assets('css/hope-ui.min.css?v=2.0.0') ?>" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="<?= b_assets('css/custom.min.css?v=2.0.0') ?>" />
    <link rel="stylesheet" href="<?= b_assets('css/custom.css?v=2.0.0') ?>" />

    <!-- Dark Css -->
    <link rel="stylesheet" href="<?= b_assets('css/dark.min.css') ?>" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="<?= b_assets('css/customizer.min.css') ?>" />

    <!-- RTL Css -->
    <link rel="stylesheet" href="<?= b_assets('css/rtl.min.css') ?>" />

    <!-- Library Bundle Script -->
    <!-- Jquery -->
    <script src="<?= b_assets('js/core/libs.min.js') ?>"></script>


    <!-- SUMMER NOTE -->
    <link rel="stylesheet" href="<?= b_assets('vendor/summernote/summernote-bs5.min.css') ?>" />
    <script src="<?= b_assets('vendor/summernote/summernote-bs5.min.js') ?>"></script>
...
<body class="  ">
    ...
    <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../dashboard/index.html" class="navbar-brand">
                ...
                <h4 class="logo-title"><?= get_setting('site_name') ?></h4>
            </a>
            ...
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item" id="dashboard">
                        <a class="nav-link" aria-current="page" href="<?= admin_url() ?>">
                            <i class="icon">
                    ...
                    <li class="nav-item" id="category">
                        <a class="nav-link" aria-current="page" href="<?= url_to('categories.list') ?>">
        ...
        <div class="position-relative iq-banner">
                        ...
                        <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="p-1 avatar-40 rounded-pill bg-soft-primary"
                                                            src="<?= b_assets('images/shapes/05.png') ?>" alt="">
                                                    </div>
                                                    <div class="ms-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown"
                                    ...
                                    <img src="<?= b_assets('images/avatars/avtar_2.png') ?>" alt="User-Profile"
                                        class="img-fluid avatar avatar-50 avatar-rounded">
                                    <div class="caption ms-3 d-none d-md-block ">
                                        <h6 class="mb-0 caption-title">Ashok kumar</h6>
                                        <p class="mb-0 caption-sub-title">Web Developer</p>
                                    </div>
                                </a>
            ...
            <div class="iq-navbar-header" style="height: 215px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    <h1 class="text-center text-capitalize"><?= $pageTitle ?? '' ?></h1>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="iq-header-img">
                    <img src="<?= b_assets('images/dashboard/top-header.png') ?>" alt="header"
        ...
        <footer class="footer">
            <div class="footer-body">
                <div class="right-panel">
                    ...
                    </script> Designed and Developed with
                    <span class="">
                    ...
                    </span> by <a href="https://www.linkedin.com/in/mimicak/">Ashok kumar</a>.
                </div>
            </div>
        </footer>
        <!-- Footer Section End -->
    </main>
    <a class="btn btn-fixed-end btn-warning btn-icon btn-setting d-none" data-bs-toggle="offcanvas"
        ...
        <div class="offcanvas-body data-scrollbar">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/03.png') ?>" alt="mini"
                            ...
                            <img src="<?= b_assets('images/settings/light/03.png') ?>" alt="mini"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-type" data-value="sidebar-mini">
                            <span class="mt-2">Mini</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/04.png') ?>" alt="hover"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                            <img src="<?= b_assets('images/settings/light/04.png') ?>" alt="hover"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                            <span class="mt-2">Hover</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/05.png') ?>" alt="boxed"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-type" data-value="sidebar-boxed">
                            <img src="<?= b_assets('images/settings/light/05.png') ?>" alt="boxed"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-type" data-value="sidebar-boxed">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/06.png') ?>" alt="rounded-one-side"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-item" data-value="navs-rounded">
                            <img src="<?= b_assets('images/settings/light/06.png') ?>" alt="rounded-one-side"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-item" data-value="navs-rounded">
                            <span class="mt-2">Rounded One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/07.png') ?>" alt="rounded-all"
                                class="mode dark-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <img src="<?= b_assets('images/settings/light/07.png') ?>" alt="rounded-all"
                                class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                            <span class="mt-2">Rounded All</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/08.png') ?>" alt="pill-one-side"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-item" data-value="navs-pill">
                            <img src="<?= b_assets('images/settings/light/09.png') ?>" alt="pill-one-side"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="sidebar"
                                data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Pill One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/09.png') ?>" alt="pill-all"
                            ...
                            <img src="<?= b_assets('images/settings/light/08.png') ?>" alt="pill-all"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class=" text-center">
                            <img src="<?= b_assets('images/settings/dark/11.png') ?>" alt="image"
                            ...
                            <img src="<?= b_assets('images/settings/light/10.png') ?>" alt="image"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                            <span class="mt-2">Glass</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/10.png') ?>" alt="color"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                            <img src="<?= b_assets('images/settings/light/11.png') ?>" alt="color"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                            <span class="mt-2">Color</span>
                        </div>
                        <div class=" text-center">
                            <img src="<?= b_assets('images/settings/dark/12.png') ?>" alt="sticky"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                            <img src="<?= b_assets('images/settings/light/12.png') ?>" alt="sticky"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                            <span class="mt-2">Sticky</span>
                        </div>
                        <div class="text-center">
                            <img src="<?= b_assets('images/settings/dark/13.png') ?>" alt="transparent"
                                class="mode dark-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                            <img src="<?= b_assets('images/settings/light/13.png') ?>" alt="transparent"
                                class="mode light-img img-fluid btn-border p-0 flex-column mb-2" data-setting="navbar"
                                data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
    ...
    <div class="modal codeingil-modal fade" id="confirmDelete" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body overflow-y-auto">
                    <div class="conatiner">
                        <div class="d-flex flex-column align-items-center justify-content-center">
                            <svg class="icon-100 py-2" width="100" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <p class="my-2 pb-3 text-center text-capitalize">This action can't be reverted</p>

                            <button id="doDelete" class="btn btn-danger py-2">
                                <div class="btn-inner"> <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                    </svg> Confirm Delete</div>
                            </button>
                            <button class="btn btn-danger py-2 d-none" id="deleteLoader" type="button" disabled>
        ...
        <script src="<?= b_assets('js/core/external.min.js') ?>"></script>

        <!-- Widgetchart Script -->
        <script src="<?= b_assets('js/charts/widgetcharts.js') ?>"></script>

        <!-- mapchart Script -->
        <script src="<?= b_assets('js/charts/vectore-chart.js') ?>"></script>
        <script src="<?= b_assets('js/charts/dashboard.js') ?>"></script>

        <!-- fslightbox Script -->
        <script src="<?= b_assets('js/plugins/fslightbox.js') ?>"></script>

        <!-- Settings Script -->
        <script src="<?= b_assets('js/plugins/setting.js') ?>"></script>

        <!-- Slider-tab Script -->
        <script src="<?= b_assets('js/plugins/slider-tabs.js') ?>"></script>

        <!-- Form Wizard Script -->
        <script src="<?= b_assets('js/plugins/form-wizard.js') ?>"></script>

        <!-- AOS Animation Plugin-->
        <script src="<?= b_assets('vendor/aos/dist/aos.js') ?>"></script>

        <!-- App Script -->
        <script src="<?= b_assets('js/hope-ui.js') ?>" defer></script>

        <!-- myMessage -->
        <script src="<?= b_assets("vendor/mymessage/js/jquery.my-message.1.1.js") ?>"></script>
        ...
        <script>
            $(document).ready(function () {
                ...
                doDelete.on('click', function (e) {
                    ...
                    deleteLoader.removeClass('d-none');
