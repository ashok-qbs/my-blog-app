...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 26, 2024 at 11:42 AM
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='This Table Is used to store the activity of the ADMINS and Staffs';
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `admins` (`id`),
